-- The Good Loose Coins - Supabase Database Schema
...
ALTER TABLE "social_impact_points" ADD CONSTRAINT "social_impact_points_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
