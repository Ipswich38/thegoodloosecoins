...
CREATE TRIGGER set_timestamp_pledges BEFORE UPDATE ON pledges FOR EACH ROW EXECUTE PROCEDURE trigger_set_timestamp();
CREATE TRIGGER set_timestamp_donations BEFORE UPDATE ON donations FOR EACH ROW EXECUTE PROCEDURE trigger_set_timestamp();
CREATE TRIGGER set_timestamp_social_impact_points BEFORE UPDATE ON social_impact_points FOR EACH ROW EXECUTE PROCEDURE trigger_set_timestamp();